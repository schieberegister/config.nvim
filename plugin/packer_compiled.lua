...
_G.packer_plugins = {
  ...
  ["dotenv.nvim"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/dotenv.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["vim-cutlass"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/vim-cutlass",
